...
void TextureData::CreateTextures(MemoryImage *theImage)
{
    ...
    {
        if (!(theImage->mD3DFlags & ImageFlag_UseA8R8G8B8))
    ...
    if ((theImage->mD3DFlags & ImageFlag_UseA4R4G4B4) && aFormat==PixelFormat_A8R8G8B8 && (gSupportedPixelFormats & PixelFormat_A4R4G4B4))
