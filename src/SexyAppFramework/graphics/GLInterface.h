...
public:
	...
	void					BltRotatedAdditive(Image* theImage, float theX, float theY, const Rect* theClipRect, const Color& theColor, double theRot, float theRotCenterX, float theRotCenterY, const Rect& theSrcRect);
